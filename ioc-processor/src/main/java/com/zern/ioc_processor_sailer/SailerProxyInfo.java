...
//
//    public SailerProxyInfo(final Elements elementUtils, final TypeElement typeElement) {
...
//        stringBuilder.append("// Generate code. Do not modify it 我是编译自动生成Zern 代码!\n")
